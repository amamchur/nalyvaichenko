...
using tty_tx_transport = zoal::utils::usart_transmitter<tty_usart, 32, zoal::utils::interrupts_off>;
using df_player_tx_transport = zoal::utils::usart_transmitter<df_player_usart, 16, zoal::utils::interrupts_off>;
